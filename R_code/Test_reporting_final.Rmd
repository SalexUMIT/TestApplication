...
| :---------------------------------------- | :------------ | 
| IST-Kapazität, mit SOLL-Wert verglichen|  `r print(capacity_pass)`             |
| IST-Spannung mit SOLL-Wert verglichen|  `r print(voltage_pass)`             |
| IST-Stromstärke mit SOLL-Stromstärke |  `r print(current_pass)`             |
| Der IST-Maximalwert der Kapazität mit dem SOLL-Wert verglichen|  `r print(max_discharge_pass)`              |
| Der IST-Minimalwert der Kapazität mit dem SOLL-Wert verglichen|  `r print(min_discharge_pass)`              |
